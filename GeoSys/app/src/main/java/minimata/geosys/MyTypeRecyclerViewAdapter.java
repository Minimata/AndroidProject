...
import minimata.geosys.TypeFragment.OnListFragmentInteractionListener;
...
public class MyTypeRecyclerViewAdapter extends RecyclerView.Adapter<MyTypeRecyclerViewAdapter.ViewHolder> {
    ...
    public MyTypeRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
